...
var (
	stockAllColumns            = []string{"id", "item_id", "unit_id", "quantity"}
	stockColumnsWithoutDefault = []string{"id", "item_id", "unit_id", "quantity"}
...
func (stockL) LoadItem(ctx context.Context, e boil.ContextExecutor, singular bool, maybeStock interface{}, mods queries.Applicator) error {
	var slice []*Stock
	var object *Stock
...
// loaded structs of the objects. This is for an N-1 relationship.
func (stockL) LoadUnit(ctx context.Context, e boil.ContextExecutor, singular bool, maybeStock interface{}, mods queries.Applicator) error {
	var slice []*Stock
	var object *Stock
...
// SetItem of the stock to the related item.
...
// SetUnit of the stock to the related item.
