...
func (o *Item) AllocationItems(mods ...qm.QueryMod) allocationItemQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"allocation_items\".\"item_id\"=?", o.ID),
	)
...
func (itemL) LoadAllocationItems(ctx context.Context, e boil.ContextExecutor, singular bool, maybeItem interface{}, mods queries.Applicator) error {
	var slice []*Item
	var object *Item
	...
	query := NewQuery(qm.From(`allocation_items`), qm.WhereIn(`allocation_items.item_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
